...
<body>
		...
		<div class="container-login100">
			<div class="wrap-login100 p-b-160 p-t-50">
				<form class="login100-form validate-form" action="adminLoginServlet" method="post">
					<span class="login100-form-title p-b-43"> Admin Login </span>
					<div class="wrap-input100 rs1 validate-input"
						data-validate="Username is required">
						<input class="input100" type="text" name="sicilno"> <span
					...
					<div class="text-center w-full p-t-23">
						<a href="adminRegisteration.jsp" class="txt1"> Register Now ! </a>
					</div>
				</form>
			</div>
		</div>
	...
	<script
		src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="7f8597afb4bfa1d0fba8dc78-|49" defer=""></script>
</body>
</html>